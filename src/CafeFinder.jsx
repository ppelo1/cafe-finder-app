...
const styles = {
  ...
  filterChip: { display: "flex", alignItems: "center", gap: 6, padding: "10px 16px", borderRadius: 999, border: `1px solid ${COLOR.borderSoft}`, background: COLOR.surface, color: COLOR.ink, fontSize: 13, fontWeight: 500, cursor: "pointer", whiteSpace: "nowrap", flexShrink: 0, scrollSnapAlign: "start", boxShadow: "0 4px 12px rgba(38,36,31,0.10)" },
  ...
  filterSettingsChip: { display: "flex", alignItems: "center", justifyContent: "center", width: 42, height: 42, borderRadius: 999, border: `1px solid ${COLOR.borderSoft}`, background: COLOR.surface, cursor: "pointer", flexShrink: 0, scrollSnapAlign: "start", boxShadow: "0 4px 12px rgba(38,36,31,0.10)" },
